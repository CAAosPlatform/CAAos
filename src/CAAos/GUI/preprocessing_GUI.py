...
class preprocessing_GUI(QtWidgets.QWidget):
    ...
    def newJob(self):
        ...
        self.data.newJob(inputFile=self.fileName)
        self.createTabs()
    ...
    def loadJob(self):
        ...
        self.parent().setWindowTitle(self.parent().name + ' - ' + self.fileName)
        self.data = patientProcessing()
        self.data.loadJob(self.fileName, 'preprocessing')
        self.createTabs()
    ...
    def importOperations(self):
        ...
        self.data.import_PPO_ARO_Operations(self.data.dirName + os.path.basename(fileName_PPO), elemPosition=None, runOperations=True)
