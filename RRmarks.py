...
from signalPlotWidget import plotArray,signalPlot,pyQtConf
...
class heartRatePlotWidget(pg.GraphicsLayoutWidget):
    ...
    def setData(self,RRmarks,samplingRate_Hz):
        ...
        self.yData=np.reciprocal(np.diff(RRmarks/(self.samplingRate_Hz)))*60.0  # computes the sample difference between peaks and converts to bpm
