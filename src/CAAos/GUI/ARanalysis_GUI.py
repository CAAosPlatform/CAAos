...
class ARanalysis_GUI(QtWidgets.QWidget):
    ...
    def loadJob(self):
        ...
        if True:
            ...
            print('LOAD de arquivo abreviado! ver autoregulation_GUI.py, linha 74')
            self.fileName = '/home/fernando/servidor/programas/00_UFABC/ProjetoPosDocAngela/data/CG24HG_preprocessing.job'
        ...
        self.data = patientProcessing()
        self.data.loadJob(self.fileName, 'ARanalysis')
        self.createTabs()
    ...
    def reloadJob(self):
        ...
        self.data = patientProcessing(self.fileName)
        self.data.setActiveModule('ARanalysis')
        self.createTabs()
    ...
    def importOperations(self):
        ...
        self.data.import_PPO_ARO_Operations(self.data.dirName + os.path.basename(fileName_ARO), elemPosition=None, runOperations=True)
